...
const char* chSSID = "WIFI SSID"; //Insert WIFI SSID here, keep the quotes
const char* password = "PASSWORD"; //Insert WIFI password here, keep the quotes
...
void getLightStatus(){
  ...
  client.print(String("GET ") + url + "?duration=2 HTTP/1.1\r\n" +
              ...
              "Authorization: Bearer [Device token]\r\n" + //Add your device token here, remove []
              "Connection: close\r\n\r\n");
